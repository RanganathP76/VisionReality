  ...
  return (
    <header className="sticky top-0 z-50 bg-[#faf9f6]/95 backdrop-blur-md border-b border-yellow-200 shadow-lg">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-5 relative">
        {/* Hamburger on Left */}
        <button
          className="md:hidden w-11 h-11 flex flex-col items-center justify-center rounded-xl border border-yellow-400 bg-white shadow absolute left-0"
        ...
        <Link
          to="/"
          className="mx-auto text-4xl md:text-5xl font-extrabold tracking-wide flex items-center gap-1 group"
        >
